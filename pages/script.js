              ...
              <div class="menu">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a href="Places to Visit/places.html">Explore Places</a>
                    <a href="Food.html">Food Delights</a>
                    <a href="Hyderabad Hotels.html">Accommodation</a>
          ...
          <div class="navbar-content">
            ...
            <div class="absolute top-0 right-0 h-screen w-1/3 bg-white nav2 text-black">
              <div class="px-6 py-4">
                ...
                <a class="ml-4" href="blog/blog.html">Blog</a>
                <div class="dropdown">
                  <a href="#">About</a>
                  <div class="dropdown-menu">
                    <a href="about/history.html">History</a>
                ...
                <a class="ml-4" href="about/gallery.html">Gallery</a>
              </div>
            </div>
          </div>
        </div>`;
